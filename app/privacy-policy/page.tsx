...
export const metadata: Metadata = {
  ...
  description: 'Learn about how Frame collects, uses, and protects your personal information.',
};
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Personal Information We Collect or Process</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Personal Information Sources</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">How We Disclose Personal Information</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Children's Data</h2>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Security and Retention of Your Information</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
